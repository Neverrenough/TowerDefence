...
namespace SpaceShooter
{
    ...
    public class SpaceShip : Destructible
    {
        ...
        {
            //Debug.Log($"Уменьшение скорости. Было: {m_MaxLinearVelocity}");
            m_MaxVelocityBackup = m_MaxLinearVelocity;
            m_MaxLinearVelocity /= 2;
            //Debug.Log($"Стало: {m_MaxLinearVelocity}");
        }
        ...
        protected override void Start()
        {
            ...
            if (m_MaxLinearVelocity <= 0)
            {
                //Debug.LogWarning("m_MaxLinearVelocity не установлен. Используется значение по умолчанию: 5.");
                m_MaxLinearVelocity = 5; // Пример значения по умолчанию
            }
        }
        ...
        private void UpdateRigidbody()
        {
            ...
            {
                m_MaxLinearVelocity = 2;
                //Debug.LogWarning("m_MaxLinearVelocity менее или равен нулю.");
            }
        ...
        */
        ...
        {
            //Debug.Log($"Изменение скорости от врага. Было: {m_MaxLinearVelocity}, Новое: {asset.moveSpeed}");
